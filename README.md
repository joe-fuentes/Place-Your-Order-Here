...
The demo of the burger eating application can be found [here](https://pure-forest-33539.herokuapp.com/index).

## Installation

To run the application locally, first clone this repository with the following command.

  git clone https://github.com/joe-fuentes/burger.git
